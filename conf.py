...
latex_documents = [
    (master_doc, 'pydago.tex', "Formation enseignants",
...
man_pages = [
    (master_doc, 'pydago', 'pydago Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pydago', 'pydago Documentation',
     author, 'pydago', 'Environement python du lycée diderot',
     'Miscellaneous'),
]
